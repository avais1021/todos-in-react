...
const TodoItem = ({ todos }) => {
  ...
  return (
    <div
      ...
      <textarea
        type="text"
        className={` ${isEditable ? "bg-lime-100 border-amber-400" : " bg-transparent border-teal-950 border outline-none"}  w-full  rounded-lg px-2 ${todos.checked ? 'line-through' : ''}  `}
        value={editText}
